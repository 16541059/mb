...
@section('title', 'Seviye Tespit Sınavı')

@section('content_header')

    <h3>Seviye Tespit Sınavına Katılan Öğrenciler</h3>
@stop
...
@section('content')
    ...
    <div class="d-flex justify-content-end">
        <button class="btn btn-danger mb-1 mr-2"  onclick="deleteall(event,'','{{route("admin.resultplacement.deleteall")}}')" >Seçimleri Sil</button>
                ...
                @foreach($data as $row)
                    <tr id="item_{{$row["id"]}}" >
                       ...
                       {{--     <a href="{{route("admin.resultplacement.detail",[$row["id"]])}}"> detay</a>--}}
                            ...
                            <button class="btn btn-danger"  onclick="deleteitem(event,'','{{route("admin.resultplacement.delete",["id"=>$row["id"]])}}')" ><i class="fas fa-trash"></i> Sil</button>
                        </td>
                    </tr>
                @endforeach
                </tbody>
            ...
            <div class="modal-dialog modal-xl"   role="document">
                ...
                <div  class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Soru Detayları</h5>
