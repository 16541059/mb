...
<div class="col-md-12">
    ...
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        {!! Form::open(['route' => ['admin.egitim.put', $data[0]["id"]],"enctype"=>"multipart/form-data"]) !!}
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                {!!Form::select('parent_id',["0"=>"En üstde göster"]+ $category  ,$data[0]["parent_id"],["class"=>"form-control"]) !!}
            </div>
            <div class="form-group">
