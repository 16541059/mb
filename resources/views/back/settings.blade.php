    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Siteyi Düzenle</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            {!! Form::open(['route' => ['admin.settings.put', $data["id"]],"enctype"=>"multipart/form-data"]) !!}
            ...
            <div class="card-body">
                ...
                <div class="form-group" hidden>
                    ...
                    {!! Form::textarea('about',$data["about"],["class"=>"form-control summernote","id"=>"summernote"]) !!}
                </div>
                <div class="form-group" hidden>
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('day',(isset(json_decode($data["sosial"])->day)?(json_decode($data["sosial"])->day):""),["class"=>"form-control summernote","id"=>"summernote","required"]) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('time', "Çalışma Saatleri") !!}
                    {!! Form::text('time',(isset(json_decode($data["sosial"])->time)?(json_decode($data["sosial"])->time):""),["class"=>"form-control summernote","id"=>"summernote","required"]) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('adres', "Adres") !!}
                    {!! Form::text('adres',(isset(json_decode($data["sosial"])->adres)?(json_decode($data["sosial"])->adres):""),["class"=>"form-control summernote","id"=>"summernote","required"]) !!}
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('tel',(isset(json_decode($data["sosial"])->tel)?(json_decode($data["sosial"])->tel):""),["class"=>"form-control summernote","id"=>"summernote","required"]) !!}
                </div>

                    <div class="form-group">
                        {!! Form::label('cep', "Cep Telefon") !!}
                        {!! Form::text('cep',(isset(json_decode($data["sosial"])->cep)?(json_decode($data["sosial"])->cep):""),["class"=>"form-control summernote","id"=>"summernote","required"]) !!}
                    </div>
                <div class="form-group">
                    {!! Form::label('mail', "Mail") !!}
                    {!! Form::text('mail',(isset(json_decode($data["sosial"])->mail)?(json_decode($data["sosial"])->mail):""),["class"=>"form-control summernote","id"=>"summernote","required"]) !!}
                </div>
                <div class="form-group">
