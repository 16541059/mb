...
@section('title', 'Fotoğra galerisi')
...
@section('content')
    ...
    <div class="d-flex justify-content-end">
        <button class="btn btn-danger mb-1 mr-2" onclick="deleteall(event,'','{{route("admin.image.deleteall")}}')">
            Seçimleri Sil
        </button>
    ...
    <div class="col-12">
        <div class="card card-primary">
            <div class="card-header">
                <h4 class="card-title">Fotoğraf Galerisi</h4>
            </div>
            <div class="card-body">
                <div class="row">
                    @foreach($data as $row)
                    <div id="item_{{$row["id"]}}"  class="col-sm-2  ">
                        ...
                        <button class="btn btn-danger"  onclick="deleteitem(event,'','{{route("admin.image.delete",["id"=>$row["id"]])}}')" ><i class="fas fa-trash"></i> Sil</button>
...
@section('js')
    <script>
        ...
        var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
            url: "{{route("admin.image.post")}}", // Set the url
            headers: {
