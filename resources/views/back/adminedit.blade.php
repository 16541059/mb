...
@section('content')
    ...
    <div class="d-flex justify-content-end">
        <a class="btn btn-primary mb-3" href="{{route("admin.admin.index")}}">Kullanıcılar</a>
    </div>
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Kullancı Düzenle</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            {!! Form::open(['route' => ['admin.admin.put',"id"=>$data[0]["id"]],"enctype"=>"multipart/form-data"]) !!}
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    {!! Form::label('tc', "TC") !!}
                    {!! Form::text('tc',$data[0]["tc"],["class"=>"form-control","required"]) !!}
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    {!! Form::tel('tel',$data[0]["tel"],["class"=>"form-control","required"]) !!}
                </div>
                {{--   <div class="form-group">
