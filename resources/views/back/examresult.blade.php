                ...
                @foreach($data as $row)
                    <tr id="item_{{$row["id"]}}" >
                        ...
                        <td class="text-center pr-0 pl-0" >
                            <a href="{{route("admin.examresult.update",["id"=>$row["id"]])}}"  class="btn btn-primary"   class="btn btn-warning" ><i class="fas fa-eye"></i> Öğrenci Sonuçları Görsün</a>
                            <a href="{{route("admin.examresult.edit",["id"=>$row["id"]])}}"  class="btn btn-warning"   class="btn btn-warning" ><i class="fas fa-edit"></i> Sonuçlar</a>
