...
@section('content')
    ...
    <div class="d-flex justify-content-end">
        <a class="btn btn-primary mb-3" href="{{route("admin.campaing.index")}}">Kampanyalar</a>
    </div>
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            {!! Form::open(['route' => ['admin.campaing.put', $data[0]["id"]],"enctype"=>"multipart/form-data"]) !!}
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        {!! Form::label('description', "Başlık") !!}
                        {!! Form::textarea('description',$data[0]["description"],["class"=>"form-control","id"=>"summernote","required"]) !!}
                    </div>
