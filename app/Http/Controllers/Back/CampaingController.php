...
class CampaingController extends Controller
{
    ...
    public function post(Request $request)
    {
        ...
        $all["image"] = imageUpload::singleUpload("campaing", $request->file("image"), 860, 600);
    ...
    public  function  put(Request  $request){
        ...
        $w =Campaign::where("id",$id)->get();
        $all["slug"]=mHelper::slug($all["title"]);
        $all["image"]= imageUpload::singleUploadUpdate("campaing",$request->file("image"),$w,"image",860,600);
